...
This event's request payload is of type [SystemNotificationEventBody](../../../../doc/models/containers/system-notification-event-body.md).
...
app.post('/webhooks', (req: Request, res: Response) => {
  ...
  if (WebhooksBParsingResult.isSystemNotificationEventEvent(result)) {
